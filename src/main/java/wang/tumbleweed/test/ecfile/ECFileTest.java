package wang.tumbleweed.test.ecfile;
...
import wang.tumbleweed.common.EncryptUtil;
import wang.tumbleweed.common.HttpPostUtil;
import wang.tumbleweed.model.FileParams;
import wang.tumbleweed.test.base.XmlTest;
...
//        FileParams fileParams = new FileParams("20150314000000110000000000000010","1432126079881KL91111111113879745","4","18701360647","18600668603","test.png","2");
...
//        String fileName = java.net.URLEncoder.encode("测试vtm.png","UTF-8");
        ...
        File file = new File("src/yun/tong/xun/file/test.png");
