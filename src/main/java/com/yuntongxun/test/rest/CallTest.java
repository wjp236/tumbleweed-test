...
//        root.addElement("callStateUrl").addText("http://192.168.21.56:8881/2013-12-26/Calls/voiceCapctha1");
//        root.addElement("respUrl").addText("http://192.168.21.56:8881/2013-12-26/Calls/voiceCapctha1");// 用户接听呼叫后，发起请求通知应用侧。
        // 可选
//        root.addElement("playTimes").addText("2");// 播放次数，1－3次
//        root.addElement("respUrl").addText("http://192.168.178.219:8088/ivrDialVoice/wjp");// 用户接听呼叫后，发起请求通知应用侧。
...
//        root.addElement("callStatePush").addText("0");
        ...
        String url = "http://192.168.21.56:8881/2013-12-26/Accounts/"+mainAccount+"/Calls/VoiceVerify";
        HttpPostUtil HttpPostUtil = new HttpPostUtil();
    ...
    public void LandingCalls() throws ClientProtocolException,
        ...
        root.addElement("to").addText("18600442522");
        root.addElement("mediaTxt").addText("欢迎使用营销外呼,欢迎，使用。营销外呼");
        ...
        String body = document.asXML();
        String mainAccount = "ff8081813fc65581013fc72b94880000";
...
//        String url = "http://localhost:8080/2013-12-26/Accounts/" + mainAccount + "/Calls/LandingCalls";
        String url = "http://192.168.178.10:8020/2013-12-26/Accounts/" + mainAccount + "/Calls/LandingCalls";
        HttpPostUtil HttpPostUtil = new HttpPostUtil();
    ...
    public void voiceVerifyDone() throws ClientProtocolException,
        ...
        root.addElement("action").addText("voiceBeginCall");//voiceBeginCall  voiceAlerting  voiceCapctha  voiceAnswer
        root.addElement("callId").addText("15061216590396940001000200000001");
        root.addElement("number").addText("18600200156");
        root.addElement("hisuncallId").addText("15061216590396940001000200000001");// 用户私有数据。和语音验证码接口的私有数据一致

        root.addElement("calltime").addText("20160218000000");

        root.addElement("alertingtime").addText("20160218000000");

        root.addElement("answertime").addText("1501130830415011308304");// 应答时间yyyymmddhhmmss
        ...
        root.addElement("startcalltime").addText("20160218000000");// 开始呼叫时间yyyymmddhhmmss
        root.addElement("userData").addText("userData");// 用户私有数据。和语音验证码接口的私有数据一致
        ...
        String url = "http://192.168.21.56:8881/2013-12-26/Calls/voiceCapctha";// 本地
