...
import com.tumbleweed.test.enn.common.HttpPostUtil;
import com.tumbleweed.test.enn.model.XinyipayPo;
import com.tumbleweed.test.enn.util.DateUtils;
import com.tumbleweed.test.enn.util.ShardTimeUtil;
...
//        root.addElement("hui10").addText("hui10");
...
//        json.put("notify_url", serverUrl + "/xinyi/make/signature");
    ...
    public void testMq() throws IOException, NoSuchAlgorithmException {
        ...
        String url = localServerUrl + "/xinyi/hui10/mq";
...
//        HttpPostUtil.sendJSON(url, json.toString());
    ...
    public void disconf() throws IOException, NoSuchAlgorithmException {
        ...
        String url = localServerUrl + "/xinyi/hui10/disconf";
    ...
    public void logback() throws IOException, NoSuchAlgorithmException {
        ...
        String url = localServerUrl + "/xinyi/hui10/logback";
    ...
    public void log4j2() throws IOException, NoSuchAlgorithmException {
        ...
        String url = localServerUrl + "/xinyi/hui10/log4j2";
