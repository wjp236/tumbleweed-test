...
public class DateUtil {
    ...
    public static String getSpecifiedDayAfter() {
        ...
        String timeExpire  = DateUtils.getSpecifiedDayAfter(sdf.format(date), "yyyyMMddHHmmss");
        return timeExpire;
    }
    ...
    public static boolean isFormatTime(String time) {
        try {
            Date d = org.apache.commons.lang.time.DateUtils.parseDate(time, DATE_PATTERN2);
