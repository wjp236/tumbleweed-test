...
public class IMTest {
    ...
    public void pushMessage() throws NoSuchAlgorithmException, IOException {
        ...
        json.put("pushType", "1");
        json.put("sender", "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456");
        json.put("receiver", senders);
        json.put("msgType", "1");
        json.put("msgContent","123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456");
