...
public class CHexConver
{
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        String temp = "A00000X";
        System.out.println(CHexConver.str2HexStr(temp));

        int length = temp.length();

        System.out.println(CHexConver.str2HexStr(String.valueOf(length)));

        String hex = CHexConver.str2HexStr(temp);
        System.out.println(CHexConver.hexStr2Str(hex));
