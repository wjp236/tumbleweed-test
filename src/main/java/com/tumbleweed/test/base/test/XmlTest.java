...
import com.tumbleweed.test.yuntongxun.model.*;
import com.tumbleweed.test.yuntongxun.util.JaxbUtil;
...
import org.ming.sample.xml.XMLSetup;
import org.ming.sample.xml.XMLUtil;
import org.xml.sax.SAXException;
import com.tumbleweed.test.yuntongxun.util.XStreamUtil;
...
public class XmlTest {
    ...
    public void xmlTestOld() throws DocumentException, JAXBException {
        ...
        log.info("begin old");
        long t1 = System.currentTimeMillis();
        ObjectUtil binder = new ObjectUtil(com.tumbleweed.test.yuntongxun.model.XmlTest.class);
    ...
    public void xmlTestNew() throws DocumentException, JAXBException {
        ...
        log.info("begin new");
        long t3 = System.currentTimeMillis();
        JAXBContext ctx = JAXBContext.newInstance(com.tumbleweed.test.yuntongxun.model.XmlTest.class);
        Unmarshaller marchaller = ctx.createUnmarshaller();
        com.tumbleweed.test.yuntongxun.model.XmlTest xmlTest = (com.tumbleweed.test.yuntongxun.model.XmlTest) marchaller.unmarshal(new StringReader(value));
        long t4 = System.currentTimeMillis();
        log.info("end new");
        log.info("new--------" + (t4 - t3));
    ...
    public void xmlTestSax() throws DocumentException, JAXBException {
        ...
        log.info("begin new");
        long t3 = System.currentTimeMillis();
        JaxbUtil resultBinder = new JaxbUtil(com.tumbleweed.test.yuntongxun.model.XmlTest.class, JaxbUtil.CollectionWrapper.class);
        com.tumbleweed.test.yuntongxun.model.XmlTest xmlTest = resultBinder.fromXml(value);
        long t4 = System.currentTimeMillis();
        log.info("end new");
        log.info("new--------" + (t4 - t3));
    ...
    public void xmlTestXStream() throws DocumentException, JAXBException {
        ...
        log.info("begin new");
        long t3 = System.currentTimeMillis();
        com.tumbleweed.test.yuntongxun.model.XmlTest xmlTest = XStreamUtil.toBean(value, com.tumbleweed.test.yuntongxun.model.XmlTest.class);
        long t4 = System.currentTimeMillis();
        log.info("end new");
        log.info("new--------" + (t4 - t3));
    ...
    public void xmlTestDigester() throws DocumentException, JAXBException, IOException, SAXException {
        ...
        digester.addObjectCreate("TemplateSMS", com.tumbleweed.test.yuntongxun.model.XmlTest.class);
        ...
        com.tumbleweed.test.yuntongxun.model.XmlTest xmlTest = (com.tumbleweed.test.yuntongxun.model.XmlTest) digester.parse(new StringReader(value));
...
//        ServerAddrs serverAddrs = (ServerAddrs) JSONObject.toBean(jsonObject, ServerAddrs.class, classMap);
    ...
    @Test
    public void test3() {
        XMLSetup xmlset = new XMLSetup("Request");
        xmlset.append("Appid", "");
        xmlset.append("ConfRecord").addAttribute("confid", "123456")
                .addAttribute("timeoutrecordurl", null);
        log.info(xmlset.builder());
    }
}
