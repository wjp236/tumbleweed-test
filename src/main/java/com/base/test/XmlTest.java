...
import com.yuntongxun.model.*;
import com.yuntongxun.util.JaxbUtil;
...
import com.yuntongxun.util.XStreamUtil;
...
public class XmlTest {
    ...
    public void xmlTestOld() throws DocumentException, JAXBException {
        ...
        log.info("begin old");
        long t1 = System.currentTimeMillis();
        ObjectUtil binder = new ObjectUtil(com.yuntongxun.model.XmlTest.class);
    ...
    public void xmlTestNew() throws DocumentException, JAXBException {
        ...
        log.info("begin new");
        long t3 = System.currentTimeMillis();
        JAXBContext ctx = JAXBContext.newInstance(com.yuntongxun.model.XmlTest.class);
        Unmarshaller marchaller = ctx.createUnmarshaller();
        com.yuntongxun.model.XmlTest xmlTest = (com.yuntongxun.model.XmlTest) marchaller.unmarshal(new StringReader(value));
        long t4 = System.currentTimeMillis();
        log.info("end new");
        log.info("new--------" + (t4 - t3));
    ...
    public void xmlTestSax() throws DocumentException, JAXBException {
        ...
        log.info("begin new");
        long t3 = System.currentTimeMillis();
        JaxbUtil resultBinder = new JaxbUtil(com.yuntongxun.model.XmlTest.class, JaxbUtil.CollectionWrapper.class);
        com.yuntongxun.model.XmlTest xmlTest = resultBinder.fromXml(value);
        long t4 = System.currentTimeMillis();
        log.info("end new");
        log.info("new--------" + (t4 - t3));
    ...
    public void xmlTestXStream() throws DocumentException, JAXBException {
        ...
        log.info("begin new");
        long t3 = System.currentTimeMillis();
        com.yuntongxun.model.XmlTest xmlTest = XStreamUtil.toBean(value, com.yuntongxun.model.XmlTest.class);
        long t4 = System.currentTimeMillis();
        log.info("end new");
        log.info("new--------" + (t4 - t3));
    ...
    public void xmlTestDigester() throws DocumentException, JAXBException, IOException, SAXException {
        ...
        digester.addObjectCreate("TemplateSMS", com.yuntongxun.model.XmlTest.class);
        ...
        com.yuntongxun.model.XmlTest xmlTest = (com.yuntongxun.model.XmlTest) digester.parse(new StringReader(value));
